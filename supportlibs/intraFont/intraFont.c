...
#define ALIGN_ADDR(s) (( (u32)(s) ) & ~63)
#define ALIGN_SIZE(s) (( ( (u32)(s) ) + 63) & ~63)
...
float intraFontPrintColumnUCS2Ex(intraFont *font, float x, float y, float column, const cccUCS2 *text, int length) {
	...
	const int guget_memsize = ((n_glyphs+n_sglyphs)<<1) * sizeof(fontVertex);
	v = (fontVertex*)((u32)sceGuGetMemory(guget_memsize) & ~0x40000000);
